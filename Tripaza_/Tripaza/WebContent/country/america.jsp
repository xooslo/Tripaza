            ...
            <div id="wrapper1">
                <div id="wrappper2">
                    <div class="aside">
                        ...
                        <h4><i class="fa-solid fa-house"></i> <a href="http://localhost:8090/index.jsp">홈</a> 〉 나라 별 보기 〉 미국 </h4>
                        ...
                        <div class="Section-2">
                            <aside class="sub1">
                                <div class="community">
                                    ...
                                    <ul>
                                        <h3>나라 정보</h3>
                                        <li class="li2"><i class="fa-solid fa-flag"></i> 워싱턴 D.C. </li>
                                        <li class="li2"><i class="fa-solid fa-language"></i> 영어 </li>
                                        <li class="li2"><i class="fa-solid fa-sack-dollar"></i> 달러($) </li>
                                        <li class="li2"><i class="fa-solid fa-temperature-half"></i> -2°C ~ 32°C </li>
                                    </ul>
                                </div>
                            </aside>
                        </div>
					...
					<div class="landmark">
                        ...
                        미국의 대표적인 건축물이자 랜드마크, 상징으로 통하며, 탑은 격자 구조로 이루어져 있고 파리에서 가장 높은 건축물에 속한다.<br>
                        ...
                        맨 처음 건설될 당시에만 해도 ‘흉물’ 또는 ‘천박하다’ 등의 비판을 받은 에펠탑이지만, 현재의 에펠탑은 미국의 자부심이자 랜드마크로 자리 잡았다. </p>
                        <img src="/images/미국/자유의여신상.jpg" alt="ImgErr" id="imgF">

                        <h4>할리우드</h4>
                        <p>이 기념비는 미국을 위해 봉사를 한 목숨을 바친 사람들의 기념으로 세워졌으며, <br> 
                        ...
                        <img src="/images/미국/할리우드.jpg" alt="ImgErr" id="imgF">
                        <hr>
					</div>
					<div class="traditional-food">
                        <h2>대표음식</h2>
                        <h4>여러 인종, 다양한 음식 문화</h4>
                        <p>미국하면 보통 에펠탑이나 개선문, 루브르 박물관, 또는 명품 브랜드 등을 떠올린다. 하지만 미국이 세계 최고의 미식 국가라는 사실을 잊지말자.<br>
                        미국은 북유럽과 남유럽 사이에 있어 역사적으로 많은 문화가 뒤섞여있는 국가로, 지역마다 요리도 천차만별인데 수도인 파리에서는 이 모든 요리를 맛볼 수 있다.<br>
                        미국에서 꼭 먹어봐야 하는 음식 꼽히는 것으로는 콩피 드 까나르, 푸아그라, 에스카르고, 부야베스 등이 있다. </p>
                        <img src="/images/미국/미국음식.jpg" alt="ImgErr" id="imgF">
                    </div>
                        <hr>
					<div class="traditional">
                        <h2>문화</h2>
                        <h4>미국의 문화</h4>
                        <p>미국의 문화는 깊은 역사적 사건들과, 외국 및 내부 힘과 그룹, 여러 지리적 요건들에 의해 형성되었다. <br>
                        프랑스, 특히 파리는 유럽에서 처음으로 17세기 이후 높은 문화의 중심지로서 전세계에서 중요한 역할을 하고 있다. <br>
                        19세기 후반부터 프랑스는 영화, 패션과 요리에서 중요한 역할을 하고 있다. 미국 문화의 중요성은 경제적, 정치적, 군사적 주용성에 따라 수세기에 걸쳐 흥망성쇠하고 있다. <br>
                        오늘날 프랑스 문화는 큰 지역 및 사회 경제적 차이에 의해 강력한 통합 경향을 나타나고 있다.</p><br>
                        <img src="/images/미국/센트럴파크.jpg" alt="imgErr" id="imgF">
					</div>
                    </div>
                </div>
            </div>
